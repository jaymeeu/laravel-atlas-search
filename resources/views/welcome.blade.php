...
<div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
    ...
    <div
        ...
        <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
            ...
            <div class="w-full flex pt-8 items-center justify-center flex-col">

                <div class="w-[500px] mb-4 relative">
                    <form
                        class="p-2 pl-5 rounded-[30px] flex justify-between items-center border border-gray-300 bg-white w-full shadow-[0px_1px_7px_rgba(235,235,235,0.94)]">
                        <input class="flex-1 outline-none border-0 text-gray-600" type="text" placeholder="Search movie"
                            oninput="handleSearch(event)" />
                    </form>

                    <div id="search-results"
                        class="bg-white shadow-[0px_1px_7px_rgba(235,235,235,0.94)] rounded-[15px] absolute top-[65px] p-5 flex flex-col gap-[15px]">
                    </div>
    ...
    <script>
        ...
        function handleSearch(event) {
            ...
            debounceTimer = setTimeout(() => {
                if (query.length > 2) { // Only search when input is more than 2 characters
        ...
        function displayResults(movies) {
            ...
            resultsDiv.innerHTML = movies.map(movie => ` <div onclick="fetchMovies('${movie.title}')" class='select-none text-gray-600 cursor-pointer flex items-center gap-[10px]'>
                                                       <div>
                                                           ${movie.title}
                                                       </div>
                                                   </div>`).join('');
